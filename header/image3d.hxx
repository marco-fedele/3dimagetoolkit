...
namespace im3d
{
	...
	public:
		...
		inline uint getdimx () const {return this->dimx;};
		
		//! Member to get Y dimension \ref dimy.
		inline uint getdimy () const {return this->dimy;};
		
		//! Member to get Z dimension \ref dimz.
		inline uint getdimz () const {return this->dimz;};
		...
		inline double gethx () const {return this->hx;};
		
		//! Member to get Y direction spacing \ref hy.
		inline double gethy () const {return this->hy;};
		
		//! Member to get Z direction spacing \ref hz.
		inline double gethz () const {return this->hz;};
